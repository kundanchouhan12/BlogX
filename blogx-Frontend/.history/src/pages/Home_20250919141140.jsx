...
function HeroSlider({ posts }) {
  ...
  // 👇 Hook hamesha chalega (even if posts empty)
  useEffect(() => {
    if (!posts || posts.length === 0) return; // agar posts empty hai to kuch mat karo
...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans pb-12 flex flex-col">
      {/* ✅ HeroSlider ko use kar rahe hain */}
              ...
              <div className="p-3 flex flex-col justify-between flex-grow">
                ...
                <div className="flex justify-between items-center mt-2">
                  <div className="flex items-center text-gray-500">
                    ...
                    <span className="text-sm">By {post.username || (post.user?.username) || "Anonymous"}</span>
                  </div>
                  <Link
                    to={`/posts/${post.id}`}
