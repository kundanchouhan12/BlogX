      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-grow w-full mt-12">
        ...
        <div className="grid gap-8">
          {displayedPosts.map((post) => (
            <div
              key={post.id}
              className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col md:flex-row h-52 overflow-hidden"
            >
              <img
              ...
              <div className="p-5 flex flex-col justify-between flex-grow">
                <div>
                  <h2 className="text-2xl font-bold text-indigo-800 hover:underline transition">
                    {post.title}
                  </h2>
