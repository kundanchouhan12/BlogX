          ...
          <div className="mt-16">
            ...
            <div className="relative flex items-center justify-between gap-4">
              <button
                ...
                className="px-3 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition absolute left-0 z-10 transform -translate-x-full"
              >
                Prev
              </button>
              ...
              <div className="flex gap-6 overflow-hidden w-full justify-center">
                {displayedRecommended.map((post) => (
                  <div
                    key={post.id}
                    className="w-80 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex-shrink-0"
                  >
                    <img
              ...
              <button
                ...
                className="px-3 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition absolute right-0 z-10 transform translate-x-full"
              >
                Next
              </button>
            </div>
