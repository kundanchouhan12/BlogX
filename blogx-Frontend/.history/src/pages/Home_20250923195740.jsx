      ...
      <main className="flex-grow pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-12">
          ...
          <div className="mt-16 px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-indigo-900 mb-8 tracking-tight">
              Recommended For You
            </h2>

            <div className="flex overflow-x-auto space-x-6 pb-6 scrollbar-thin scrollbar-thumb-indigo-300 scrollbar-track-transparent">
